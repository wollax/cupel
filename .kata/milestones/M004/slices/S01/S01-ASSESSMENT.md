...
Boundary map stated "PartialEq + Eq derives" for Rust. Actual: PartialEq only (D109 — f64 fields prevent Eq). No downstream impact — S02/S03/S04 use `==` operator which works with PartialEq. Boundary map inaccuracy is cosmetic.

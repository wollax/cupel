...
- [x] **T01: Create package + test project scaffolding; implement StageOnly tier** `est:25m`
...
- [x] **T02: Implement StageAndExclusions + Full tiers; complete test coverage** `est:25m`
...
- [x] **T03: Populate PublicAPI, write README, pack, wire solution** `est:15m` ✅

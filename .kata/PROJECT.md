...
- [ ] M009: CountConstrainedKnapsackSlice + MetadataKeyScorer — S01/S02/S03 complete: `CountConstrainedKnapsackSlice` in both languages with spec chapter (zero TBD); `spec/src/scorers/metadata-key.md` authored as S04 contract; S04 (MetadataKeyScorer Rust + .NET) pending

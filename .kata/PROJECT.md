...
- [x] M009: CountConstrainedKnapsackSlice + MetadataKeyScorer — `CountConstrainedKnapsackSlice` and `MetadataKeyScorer` in both Rust and .NET; spec chapters for both (zero TBD fields); 5 conformance vectors each; R062 and R063 validated (all 4 slices complete, 2026-03-25; 192 Rust tests, 804 .NET tests)

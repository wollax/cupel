...
- [ ] M003: v1.3 Implementation Sprint — Implement all M002-designed features: DecayScorer, MetadataTrustScorer, CountQuotaSlice, core analytics extension methods, budget simulation, Cupel.Testing vocabulary package, and OTel bridge companion package (2026-03-23 — S01/DecayScorer ✅, S02/MetadataTrustScorer ✅, S03/CountQuotaSlice ✅, S04/Core analytics + Cupel.Testing ✅, S05/OTel bridge ✅; S06/Budget simulation + tiebreaker + spec alignment next)

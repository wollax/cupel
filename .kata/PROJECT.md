...
- [ ] M009: CountConstrainedKnapsackSlice + MetadataKeyScorer — S01 (Rust) and S02 (.NET) complete: `CountConstrainedKnapsackSlice` implemented in both languages with Phase 1/2/3 algorithm, 5 conformance tests each, 797 .NET / 175+ Rust tests green; S03 (spec) + S04 (MetadataKeyScorer) pending
